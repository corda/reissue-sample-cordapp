...
//        issueCandyCoupons(aliceParty, 12L)
...
//
//        val aliceTokens = listAvailableCandyCoupons(aliceNode, encumbered = false)
//
...
//        )
//
//        val aliceReIssuedTokens = listAvailableCandyCoupons(aliceNode, encumbered = false)
...
//        moveDemoAppTokens(charlieNode, aliceParty, 6L)
//
//        val aliceTokens = listAvailableCandyCoupons(aliceNode, encumbered = null)
//
//        // Alice should own exactly 2 token inputs
//        val firstTokenBeforeReIssuanceBackChainTransactionIds = getTransactionBackChain(aliceNode,
//            aliceTokens[0].ref.txhash)
